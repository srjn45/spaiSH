...
spaiSH makes AI a first-class system primitive — not a chatbot on top of your OS, but a runtime woven into it. You keep your existing shell and workflow. AI gets involved only when you ask for it.
...
- [Vision](docs/vision.md) — what spaiSH is and why it exists
